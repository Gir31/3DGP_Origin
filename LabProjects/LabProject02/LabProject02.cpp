...
//
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)//실제로 윈도우를 생성하고 화면에 보여주는 초기화 함수
{
...
//
//
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)//윈도우에 발생하는 모든 메시지를 처리하는 콜백 함수
{
    switch (message)
    {
    case WM_COMMAND:
