...
{
    DWORD dwStyle = WS_OVERLAPPED | WS_CAPTION | WS_MINIMIZEBOX | WS_SYSMENU | //윈도우창의 스타일(기본골격?)의 정보를 담고있다.
        WS_BORDER;

    RECT rc = { 0, 0, 640, 480 }; //윈도우 창 크기 

    AdjustWindowRect(&rc, dwStyle, FALSE); //윈도우가 원하는 클라이언트 영역의 크기를 가지도록 윈도우의 크기를 계산하여 주는 함수 AdjustWindowRect(윈도우의 크기, 윈도위의 스타일, 메뉴를 가지도록 허용할 것인가);
