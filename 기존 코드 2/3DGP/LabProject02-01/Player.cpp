...
void CCursor::Render(HDC hDCFrameBuffer, CCamera* pCamera)
{
...
{
	p_pTurret->Render(hDCFrameBuffer, pCamera);
	CPlayer::Render(hDCFrameBuffer, pCamera);
}
...
void CTankTurret::Render(HDC hDCFrameBuffer, CCamera* pCamera)
{
	CPlayer::Render(hDCFrameBuffer, pCamera);
