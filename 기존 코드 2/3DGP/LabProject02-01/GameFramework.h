...
private:
	...
	//===== [추가] 루트 시그니처 및 CBV/SRV 힙 =====
	ID3D12RootSignature* m_pd3dGraphicsRootSignature = nullptr;         // 루트 시그니처
	ID3D12DescriptorHeap* m_pd3dCbvSrvDescriptorHeap = nullptr;         // CBV/SRV 디스크립터 힙
	UINT m_nCbvSrvDescriptorIncrementSize = 0;                          // CBV/SRV 디스크립터 증가값
...
public:
	...
	//===== D3D12 필수 생성 함수 =====
	void CreateCbvSrvDescriptorHeaps();      // CBV/SRV 디스크립터 힙 생성
	void CreateGraphicsRootSignature();      // 루트 시그니처 생성
